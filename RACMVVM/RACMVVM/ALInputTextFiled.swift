...
class ALInputTextFiled: UIView {
    ...
    lazy var inputTextFiled: UITextField = {
        ...
        view.attributedPlaceholder = NSAttributedString.init(string: showExpressPassword ? "请输入您的登录密码" : "请输入您的手机号", attributes: [NSAttributedString.Key.foregroundColor: UIColor(rgbValue: 0xBCBCBC)])
        addSubview(view)
        return view
    }()
